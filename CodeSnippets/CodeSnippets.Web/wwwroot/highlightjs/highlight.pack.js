...
subLanguage:"bash"}}]})})());hljs.registerLanguage("java",(()=>{"use strict";return e=>{
...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},r,a]}}})());hljs.registerLanguage("r",(()=>{"use strict";function e(...e){return e.map((e=>{
...
end:"`",contains:[{begin:/\\./}]}]}}})());hljs.registerLanguage("nginx",(()=>{"use strict";return e=>{const n={
...
starts:i},{className:"attr",relevance:0,begin:s+n+"$"}]}}})());hljs.registerLanguage("kotlin",(()=>{"use strict";return e=>{const n={
...
relevance:0}]}}})());hljs.registerLanguage("rust",(()=>{"use strict";return e=>{
...
},{begin:e.IDENT_RE+"::",keywords:{built_in:t}},{begin:"->"}]}}})());hljs.registerLanguage("csharp",(()=>{"use strict";return e=>{var n={
...
name:"Plain text",aliases:["text","txt"],disableAutodetect:!0})})());hljs.registerLanguage("vbnet",(()=>{"use strict";return e=>({
...
"meta-keyword":"if else elseif end region externalsource"}}]})})());hljs.registerLanguage("json",(()=>{"use strict";return n=>{const e={
...
contains:a,keywords:e,illegal:"\\S"}}})());hljs.registerLanguage("swift",(()=>{"use strict";return e=>{var i={
$pattern:/[\w#]+/,
...
end:/(?=#)|$/,contains:[b,o,r]},{begin:/\b(print|exec)\(/}]}}})());hljs.registerLanguage("go",(()=>{"use strict";return e=>{const n={
...
t.aliases=["cc","c++","h++","hpp","hh","hxx","cxx"],t}})());hljs.registerLanguage("sql",(()=>{"use strict";return e=>{
...
starts:{end:/$/,contains:[i,c,r,t,l,a]}}]}}})());hljs.registerLanguage("lisp",(()=>{"use strict";return e=>{
...
contains:[l,e.SHEBANG(),s,b,g,o,v,m,c]}}})());hljs.registerLanguage("python-repl",(()=>{"use strict";return s=>({
aliases:["pycon"],contains:[{className:"meta",starts:{end:/ |$/,starts:{end:"$",
subLanguage:"python"}},variants:[{begin:/^>>>(?=[ ]|$)/},{
begin:/^\.\.\.(?=[ ]|$)/}]}]})})());hljs.registerLanguage("fsharp",(()=>{"use strict";return e=>{const n={begin:"<",
...
}),e.C_NUMBER_MODE]}}})());hljs.registerLanguage("c",(()=>{"use strict";return e=>{const t=(e=>{
function t(e){return"(?:"+e+")?"}var n=e.COMMENT("//","$",{contains:[{
begin:/\\\n/}]
}),r="[a-zA-Z_]\\w*::",a="(decltype\\(auto\\)|"+t(r)+"[a-zA-Z_]\\w*"+t("<.*?>")+")",i={
className:"keyword",begin:"\\b[a-z\\d_]*_t\\b"},s={className:"string",
...
contains:[{beginKeywords:"final class struct"},e.TITLE_MODE]}]),exports:{
preprocessor:o,strings:s,keywords:u}}})(e)
;return t.name="C",t.aliases=["c","h"],t}})());hljs.registerLanguage("perl",(()=>{"use strict";function e(...e){
return e.map((e=>{return(n=e)?"string"==typeof n?n:n.source:null;var n
...
contains:o}}})());hljs.registerLanguage("coffeescript",(()=>{"use strict"
...
begin:t,end:a,contains:[n],relevance:5}])}}})());hljs.registerLanguage("scss",(()=>{"use strict";return e=>{var t="@[a-z-]+",i={
...
},i,e.QUOTE_STRING_MODE,e.APOS_STRING_MODE,r,e.CSS_NUMBER_MODE]}]}}})());hljs.registerLanguage("julia",(()=>{"use strict";return e=>{
...
}],a.contains=n.contains,n}})());hljs.registerLanguage("makefile",(()=>{"use strict";return e=>{const i={
...
name:"Less",case_insensitive:!0,illegal:"[=>'/<($\"]",contains:a}}})());hljs.registerLanguage("diff",(()=>{"use strict";return e=>({name:"Diff",
...
name:"TypeScript",aliases:["ts"]}),b}})());hljs.registerLanguage("latex",(()=>{"use strict";return e=>{const n=[{
...
begin:'""'}],starts:a
},e.COMMENT("^\\s*%\\{\\s*$","^\\s*%\\}\\s*$"),e.COMMENT("%","$")]}}})());hljs.registerLanguage("ada",(()=>{"use strict";return e=>{
